      ...
      <Card className="bg-black/40 border-red-800/30 backdrop-blur-sm">
        <CardContent className="p-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-purple-200">Durante tu prueba gratuita pudiste experimentar todas nuestras herramientas profesionales. ¡Ahora es momento de continuar tu crecimiento profesional!</p>
            ...
            <Dialog>
              ...
              <DialogContent className="bg-slate-900 border-purple-800/30 max-w-4xl">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-purple-200">Continúa donde lo dejaste con acceso completo a todas las herramientas</DialogDescription>
                </DialogHeader>
                <div className="grid md:grid-cols-3 gap-6 mt-6">
                  <Card className="bg-black/40 border-purple-800/30 backdrop-blur-sm">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button onClick={() => handleSubscribe('basic')} className="w-full bg-purple-600 hover:bg-purple-700 mt-6">
                        Elegir Plan
                      </Button>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-black/40 border-purple-400 backdrop-blur-sm relative">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button onClick={() => handleSubscribe('premium')} className="w-full bg-purple-600 hover:bg-purple-700 mt-6">
                        Elegir Plan
                      </Button>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-black/40 border-purple-800/30 backdrop-blur-sm">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <Button onClick={() => handleSubscribe('elite')} className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 mt-6">
                        Elegir Plan
                      </Button>
                    </CardContent>
                  </Card>
