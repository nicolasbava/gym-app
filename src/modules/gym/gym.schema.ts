...
export const baseGymSchema = z.object({
    name: z
        .string()
        .min(3, 'El nombre del gimnasio es requerido')
        .max(50, 'El nombre del gimnasio no puede tener más de 50 caracteres'),
    subscription_status: z
        .string()
        .min(4, 'El estado de suscripción es requerido')
        .max(10, 'El estado de suscripción no puede tener más de 10 caracteres'),
