            ...
            <div className="w-full max-w-md">
                ...
                <Card className="bg-black/40 border-purple-800/30 backdrop-blur-sm">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription className="text-purple-200">Únete a la comunidad Luxion</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {error && <div className="mb-4 p-3 bg-red-500/20 border border-red-500/50 rounded-md text-red-200 text-sm">{error}</div>}

                        <Button onClick={handleGoogleSignIn} variant="outline" className="w-full bg-white hover:bg-gray-100 text-gray-900 border-gray-300 mb-4">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input {...field} placeholder="Juan Pérez" className="bg-black/20 border-purple-800/50 text-white placeholder:text-purple-300" disabled={isLoading} />
                                            </FormControl>
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-purple-200 flex items-center gap-2">
                                                ...
                                                Teléfono <span className="text-purple-400 text-xs">(opcional)</span>
                                            </FormLabel>
                                            <FormControl>
                                                <Input
                                                    {...field}
                        ...
                        <div className="mt-6 text-center">
                            ...
                            <Link href="/" className="text-sm text-purple-400 hover:text-purple-300 block mt-2">
                                ← Volver al inicio
                            </Link>
                        </div>
                    </CardContent>
